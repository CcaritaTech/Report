...
| 2.0 | 16/05/2026 | Axel Ordoñez Ricaldi | Se inició el desarrollo de la segunda iteración de la aplicación móvil correspondiente al Sprint 2. Se diseñaron las primeras pantallas en Flutter, definiendo la estructura visual y la navegación inicial de la aplicación. |
| 2.1 | 17/05/2026 | Axel Ordoñez Ricaldi | Se continuó con el diseño de la aplicación móvil, refinando la interfaz de usuario y organizando las pantallas necesarias para cubrir las funcionalidades planificadas durante el Sprint 2. |
| 2.2 | 18/05/2026 | Brayan Ccarita Cruz | Se inició la implementación de las funcionalidades de la aplicación móvil en Flutter, desarrollando la navegación entre pantallas y la lógica necesaria para la interacción del usuario. |
| 2.3 | 19/05/2026 | Brayan Ccarita Cruz | Se completó la programación de las funcionalidades planificadas para el Sprint 2, integrando las pantallas desarrolladas y realizando pruebas de funcionamiento de la aplicación móvil. |
| 2.4 | 20/05/2026 | Mateo Loechle Arias | Se inició la documentación del Sprint 2 en el Capítulo IV del informe, incorporando el Sprint Planning 2, Sprint Backlog 2 y la descripción de las actividades desarrolladas durante la iteración. |
| 2.5 | 21/05/2026 | Iker Barturen Panez | Se complementó la documentación del Sprint 2 con las evidencias de desarrollo, pruebas, ejecución, documentación de servicios, despliegue y colaboración del equipo, manteniendo la estructura del informe. |
| 2.6 | 22/05/2026 | Mateo Loechle Arias e Iker Barturen Panez | Se revisó y organizó la documentación del Sprint 2, verificando la coherencia entre las evidencias, capturas, tablas y descripción de los entregables implementados durante esta iteración. |
| 2.7 | 23/05/2026 | Fabrizio Panta Castro | Se inició la revisión del informe con base en la retroalimentación brindada por el docente durante la entrega anterior, identificando los apartados que requerían correcciones y mejoras. |
| 2.8 | 24/05/2026 | Fabrizio Panta Castro | Se aplicaron las correcciones al informe, mejorando la redacción, la organización del contenido y la consistencia entre capítulos, de acuerdo con las observaciones realizadas por el docente. |
| 2.9 | 25/05/2026 | Todos | Se realizaron los últimos ajustes al diseño y programación de la aplicación móvil en Flutter, verificando el correcto funcionamiento de las pantallas implementadas y la integración de las funcionalidades desarrolladas durante el Sprint 2. |
| 3.0 | 26/05/2026 | Equipo CcaritaTech | Se integraron todos los avances correspondientes al Sprint 2. El equipo consolidó la aplicación móvil desarrollada en Flutter, la documentación de la iteración y las correcciones realizadas al informe, verificando la coherencia entre los entregables funcionales, las evidencias técnicas y la documentación final antes de la entrega. |
